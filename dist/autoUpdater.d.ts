 ...
 */
export default function autoUpdater(region: string, bucket: string, prefix?: string, credentials?: AwsCredentialIdentity | AwsCredentialIdentityProvider): ElectronPrivateS3AutoUpdater;
export {};
